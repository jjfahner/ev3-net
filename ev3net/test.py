...
from fake import FakeEV3, FakeDevice, FakeMotor, FakeMediumMotor, FakeLargeMotor
...
# Setup a fake brick
fake_ev3 = FakeEV3()
fake_ev3.add_motor(FakeMediumMotor(), 'outA')
fake_ev3.add_motor(FakeMediumMotor(), 'outB')

# Set fake brick as default instance
EV3.set_default_instance(fake_ev3)

# Create motors
motor_a = MediumMotor('outA')
motor_b = MediumMotor('outB')

print(motor_a.commands)